...
(() => {
    ...
    const textMap = {
        ...
        "TIME PLAYED": "总游戏时长",
        "RECORDS SAVED": "总记录存储",
        "AVG PIECES PER SECOND": "平均每分钟方块放置数",
        "welcome to TETR.IO": "欢迎来到TETR.IO",
        "open in": "打开",
        "DESKTOP": "桌面客户端",
        "GET": "获取",
        "puzzle together in this modern yet familiar online stacker. play against friends and foes all over the world, or claim a spot on the leaderboards - the stacker future is yours!": "欢迎游玩这款大众化的现代方块游戏。与朋友和世界各地的对手对战，在排行榜上占据一席之地——方块的未来，已在你股掌之下！",
        "enter a username to join, or leave it blank to get a random one": "输入用户名登录，或留空生成随机用户名",
        "by joining, you accept the": "注册账号并加入，即表示您接受",
        "terms of use": "使用条款",
        "privacy policy": "隐私政策",
        "and": "和",
        "rules": "规则",
        "TETR.IO is in ALPHA. please report bugs when you see them!": "TETR.IO处于ALPHA测试阶段，请在发现问题时报告错误！",
        //注册相关文本
        "want to join?": "想要加入游戏吗",
        "the nickname": "这个昵称",
        "hasn't been registered. do you want to claim it as yours, or play anonymously? you won't be able to submit scores to the leaderboards or play in matchmaking when anonymous.": "没有被注册。请问你是想把它作为你的账号，还是进行匿名游戏？匿名游玩时，你将无法向排行榜提交分数或参加TETRA排位赛。",
        "stay ANONYMOUS": "我想保持匿名",
        "REGISTER": "注册",
        "let's make things official": "让我们正式开始吧",
        "to register, please choose a password for yourself": "要想注册，请输入该账号的密码",
        //登录相关文本
        "good to see you again!": "很高兴再次见面",
        "the username": "这个用户名",
        ...
        ". making multiple accounts may result in permanent restriction of all your accounts.": ".开设多个账户可能会导致你的所有账户...喜提永久封禁。",
        "read the": "阅读",
        "full policy": "完整的政策",
        "for more info. in doubt, or if you believe your usage of a second account is justified, please": "如果您有异议，或者你有合理理由使用第二个账户，请联系我们。",
        "contact support": "联系支持",
        "I'M NOT MULTIACCOUNTING": "我没搞多账户",
        "just to be sure…": "只是为了确定...",
        "SUBMIT": "允许",
        "two-factor authentication": "2FA -- 双重认证",
        "use your authenticator app to get a six-digit code, or use one of your recovery codes.": "使用你的双重认证应用程序获得一个六位数的代码，或使用你的一个恢复代码。",
        "reset your password": "重置你的密码",
        "enter a new password to regain access to your account": "输入新的密码，从而用此密码重新进入你的账户",
        //删除账号相关文本
        ...
        "THE SONG OF DESTRUCTION CANNOT BE STOPPED.": "灭世之曲，无法终止",
        "you're certain you want to delete your account? you will lose EVERYTHING, including but not limited to...": "你确定要*永久*删除你的账户吗？ 你将失去所有的东西，包括但不限于...",
        ...
        "• and more...": "• 等等...",
        "DELETE": "删除",
        "you're absolutely, 100% certain you won't regret DELETING YOUR ACCOUNT FOREVER?": "你*绝对*、10000%确定你不会为删除你的账户而后悔，直到永远？",
        "NO REGRETS!": "永不后悔？",
        "FINAL WARNING": "最后通牒！",
        "DELETE YOUR ACCOUNT AND ALL ITS   FOREVER?": "永远删除你的账户和所有数据？（这将无法逆转）",
        "DELETE MY ACCOUNT": "删除我的账号",
        "DELETING IN": "一切曾经的辉煌沧桑，消失于尘埃之下",
        //主菜单文本
        //多人游戏相关文本
        "MULTIPLAYER": "联机游戏",
        "play online with friends and foes": "和朋友或素不相识者进行在线游戏",
        "NEW GAMEMODE!!":"全新模式！！",
        ...
        "IN QUEUE -": "排队中 - ",
        "IN GAME": "游戏中",
        "ENTER MATCHMAKING": "开始排位匹配",
        "CANCEL MATCHMAKING": "取消排位匹配",
        "LEAVING EARLY IS PUNISHED": "中途退出会受到惩罚",
        "HOW DOES IT WORK?": "这个模式是怎么运作的？",
        "enter matchmaking and you will be matched up with a player of similar skill in a game of 1v1 VERSUS.": "加入排位赛匹配，匹配成功后，您将跟一个水平差不多的玩家进行一场1V1的对战。",
        "win games to gain TR and rank up! you must play at least 10 games to see your TR. to get a RANK and enter the GLOBAL LEADERBOARDS, keep playing consistently.": "获胜可以获得TR分并晋升段位！您必须至少玩10局才能看到您的TR分。要获得段位并进入全球排行榜，请继续进行游戏。",
        ...
        "LEADERBOARDS": "排行榜",
        "estimated queue time:": "预计等待时间（以实际时间为准）：",
        "FINDING MATCH": "排位匹配中 --- 正在寻找竞争对手",
        "CLICK TO CANCEL": "点击此处取消匹配",
        "SECONDS": "秒",
        "MATCH FOUND": "已找到对手",
        "JOINING MATCH": "加入对局中",
        "GET READY FOR": "准备好...",
        ...
        "Please remember to be civil to your opponent.": "TETR.IO提醒您：文明交流你我他，请勿赛中、赛后辱骂对手",
        "the results are in!": "结果揭晓！",
        ...
        "OFF-SEASON":"淡季",
        "UNRANKED":"未定段",
        "MATCH SUSPENDED": "TETRA排位赛 --- 对局暂停",
        "Your opponent has disconnected, but may still return.": "您的对手已断开连接，但仍有可能重连。",
        "Your will gain points as you wait. If your opponent does not return,you win by default.": "您将会获得比赛分一分的等待奖励。如果对手没有重连，则您直接获胜。",
        //快速游戏相关文本
        "QUICK PLAY": "快速游玩",
        "jump into a currently ongoing match": "加入正在进行的比赛",
        "CHAT": "聊天",
        "our Discord server": "我们的Discord服务器",
        "Welcome to Quick Play chat! Please remember to be civil to your opponents - chat is actively monitored.\n\nThis chat is linked with": "欢迎来到快速游戏聊天室！文明交流你我他，您的聊天已被记录。 \n\n聊天将链接到",
        "left the room": "退出房间",
        "joined the room": "加入房间",
        "disconnected": "断开连接",
        "was yanked from the room": "被踢离房间",
        "started the game": "开始游戏",
        "aborted the game": "取消游戏",
        "ZEN WHILE WAITING": "在禅模式里热身",
        "BACK TO ROOM": "回到房间",
        "SPECTATING": "旁观中",
        "CURRENTLY INGAME": "游玩中",
        "game finished": "游戏结束",
        "welcome to": "欢迎来到",
        ...
        "PLAYING": "游玩",
        "click to switch to SPECTATORS": "点击变为旁观者",
        ...
        "click to switch to PLAYERS": "点击变为玩家",
        "SPECTATE": "旁观",
        "enter room id or url and hit enter...": "输入房间编号或邀请网址并单击回车...",
        "you just joined QUICK PLAY - the next game will start automatically. please wait just a moment longer!": "你刚刚加入了快速游戏——下一场游戏很快开始。请稍等片刻",
        "PLAYERS (": "玩家数（",
        "welcome to the ZENITH TOWER! send lines and KO enemies to scale the tower.":"欢迎来到天穹之塔！发送垃圾行并诛灭其他人，攀爬高塔",
        "the further up the tower, the stronger the opponents!":"天外有天，攀登越高，对手越强！",
        "leaderboards reset every week, how far can you get?":"排行榜每周重置，你能爬多高？",
        "ADD OR REMOVE MODS":"添加或移除规则牌",
        "YOUR FINAL ALTITUDE":"您的最终高度",
        "THIS WEEK'S PERSONAL RANK":"本周个人排名",
        "this is your first game this week, play more to track your improvement":"这是你本周的第一场对局，多多游玩以每日进步",
        ...
        "EXPERT":"专家模式",
        "joining game…":"正在加入游戏…",
        "a less lenient challenge, for those who dare":"没有那么轻松的挑战，赐予敢于突破的勇敢者",
        "EXPERT MODE":"专家难度",
        "reach floor 9 to unlock":"抵达第9层解锁",
        "DOUBLE HOLE GARBAGE":"双洞诅咒",
        "garbage may sometimes spawn with two holes":"垃圾行有时会生成两个空洞",
        "reach floor 6 to unlock":"抵达第6层解锁",
        "receive double the garbage, cancel double the garbage":"接收双倍的垃圾行，也抵消双倍的垃圾行",
        "VOLATILE GARBAGE":"垃圾堆",
        "MESSIER GARBAGE":"乱糟糟",
        "reach floor 5 to unlock":"抵达第5层解锁",
        "gravity scales up harshly by floor":"方块下坠速度随楼层急剧增加",
        "reach floor 4 to unlock":"抵达第4层解锁",
        "NO HOLD":"禁止暂存",
        "hold piece is disabled":"方块暂存被禁用",
        "reach floor 2 to unlock":"抵达第2层解锁",
        "garbage is significantly messier":"垃圾行洞口将以更混沌的随机分布",
        "reach floor 3 to unlock":"抵达第3层解锁",
        "non-garbage minos are only visible once every five seconds":"非垃圾行方块每五秒显形一次",
        "reach floor 7 to unlock":"抵达第7层解锁",
        "all-spins are rewarded, but doing the same clear twice is penalized":"其余旋转特殊攻击攻击将视为T旋特殊攻击，但重复使用相同的消除将会受到生芝士惩罚",
        "reach floor 8 to unlock":"抵达第8层解锁",
        "DUO":"双人成行",
        "scale the tower together with someone you hold close":"与挚友一起攀登高塔",
        "reset":"重置",
        "scale the tower!":"攀上高塔！",
        "challenge the tower!":"挑战高塔！",
        "overthrow the tower!":"毁灭高塔！",
        ...
        "CLEAR AN I-SPIN DOUBLE":"完成一次I旋二消",
        "CLEAR TWO S/Z-SPIN":"完成两次S或Z旋二消",
        "DOUBLES CONSECUTIVELY":"且要连续",
        "CLEAR TWO L/J-SPIN":"完成两次L或J旋二消",
        "PERFORM A COLOR CLEAR":"完成一次全部特殊旋转的消除",
        ...
        "Welcome to chat! Please remember to be civil to your opponents.": "欢迎来到聊天室! 文明交流你我他。",
        "NEW":"新",
        "ROOM": "房间",
        "MATCH": "比赛",
        "GAME": "对局",
        ...
        "allow users who are in matchmaking to join": "允许在TETRA排位赛正在等待匹配的用户进行游戏",
        "RANK LIMIT": "段位限制",
        ...
        "EXPERIMENTAL": "实验选项",
        "garbage passthrough": "垃圾行弹反",
        "limited": "限制",
        "LIMITED": "限制",
        "ZERO": "无",
        "opposing attacks in transit always cancel eachother out": "发送过程中的对立攻击总是相互抵消的。",
        "opposing attacks in transit cancel out while garbage is flying": "发送过程中的对立攻击能被抵消，有垃圾行会偶尔穿过。",
        "CONSISTENT": "相容",
        "opposing attacks in transit cancel out except when garbage is flying": "发送过程中的的对立攻击能被抵消，除非是在垃圾行未到的时候",
        "FULL": "全部",
        ...
        "an endurance-focused challenge of pure stacking intellect! almost every value is changed to imitate stacker games made many years ago.": "一个以耐力为重点的纯粹堆叠的智力挑战！为模仿多年前的开山之作，几乎改变了所有参数。",
        ...
        "RANDOM":"随机音乐",
        "RANDOM: CALM":"随机音乐：平静合集",
        "RANDOM: BATTLE":"随机音乐：战斗合集",
        ...
        "random bag type": "方块生成器类型",
        "keep shuffling a bag of the 7 tetrominoes": "保持随机排列但保证每七块包含所有种类的方块",
        "keep shuffling a bag of 2x the 7 tetrominoes": "保持随机排列但保证每14块中包含所有种类的方块各两块",
        "random with repetition protection": "具有重复保护的随机性",
        "alternate between 2 tetrominoes": "交替使用2种方块",
        "completely random generation": "纯随机生成",
        ...
        "everything is a spin because YEAH WHY NOT (O-spin SUPPORTED!)": "所有方块都能打出特殊旋转攻击？（对的支持O-Spin！）",
        "receive no spin bonuses": "旋转任何方块都没有额外攻击",
        "combo table": "连击表",
        "disable combo chaining": "禁止连击表",
        "TETR.IO's combo multiplier": "TETR.IO的连击倍增表",
        "classic guideline combo table": "经典规则连击表（最多四行）",
        "modern guideline combo table": "现代规则连击表（ZONE式连击）",
        "allow 180 spins": "允许180度旋转",
        "kick table": "踢墙系统",
        "the default natural rotation system with symmetric I-piece rotation": "默认的SRS系统，并带对称的I块旋转",
        "the standard natural rotation system": "默认的SRS系统",
        "SRS with more powerful 180 spins": "带有更强大的180度旋转的SRS系统",
        "novel rotation system by DR OCELOT": "DR OCELOT开发的旋转系统",
        "the classic rotation system": "IBM上俄罗斯方块的旋转系统",
        "rotation system used in arcade games": "被ARIKA改良过的SEGA的旋转系统。",
        "permissive rotation system by WINTERNEBS": "WINTERNEBS的七旋八转旋转系统",
        ...
        "enforced ARR": "指定触发方块重复移动延时",
        "enforced DAS": "指定方块重复移动频率",
        "enforced SDF": "制定方块下落速率",
        ...
        "none": "无",
        "enable back-to-back chaining": "启用back-to-back连锁增伤规则",
        "enable back-to-back charging": "启用back-to-back蓄力规则",
        ...
        "enable clutch clears": "启用场外抓握 -- CLUTCH消除",
        ...
        "enable all clears": "启用完美全清奖励",
        "all clear garbage": "完美全清伤害",
        "all clear back-to-back": "全消获得B2B数",
        "opener phase":"开局阶段",
        ...
        "maximum COMBO": "最大连击数",
        "maximum back-to-back chain": "最长B2B链",
        "finesse %": "极简操作率",
        "finesse faults": "非极简操作",
        "FINAL TIME": "最终时间",
        "FINAL SCORE": "最终得分",
        "RESULTS": "比赛结果",
        "got a new personal best in 40 LINES with a time of": "在40行冲刺游戏模式中取得了新的个人最好成绩，时间为",
        "got a new personal best in BLITZ with a score of": "在闪击游戏模式中取得了新的个人最好成绩，得分为",
        "has become a": "成为了",
        ...
        "GARBAGE OFFENSIVE": "垃圾洪荒",
        "lines sent": "发送垃圾行",
        "The act of violence and communication of spirit.": "暴力美学的完美体现。",
        "ELEGANCE": "优雅",
        "pieces placed with perfect finesse": "放置方块而不浪费每一操作",
        ...
        "Clear 40 LINES using only T-Spin Doubles": "仅限使用T旋二消完成40行挑战",
        ...
        "Master of all columns.": "万列归宗！", //好翻兄弟
        ...
        "Two minutes of perfection.": "顶级的两分钟。",
        "WABI-SABI": "侘寂",
        "highest BLITZ score obtained without performing any All Clears": "在闪击游戏模式下不使用任何全消的情况下获得的最高分数",
        "Two minutes of imperfection.": "不完美的两分钟。",
        "SECRET GRADE": "隐藏段位",
        "A (poorly guarded) secret.": "一个（众所周知的）秘密。",
        "CONTENDER": "挑战者",
        "rounds played": "Tetra排位赛游玩的总回合数",
        "\"Some day, everyone will remember your name!\" -Tetra League Ad": "“总有一天，你的名字将永世长青！”——Tetra排位赛广告",
        ...
        "largest spike sent (base attack, excluding margin time and Surge)": "发动的最大攻击数（基本攻击，不包含margin加成和浪涌攻击）",
        "Flashy techniques are a staple amongst Tetra League's glory-seeking competitors.":"华丽的技巧是每个想在Tetra排位赛中大放异彩的挑战者的标配。",
        "SPEED PLAYER": "速度爱好者",
        ...
        "ZENITH EXPLORER": "天穹苍鹰",
        "highest floor discovered without any mods": "在不启用任何规则牌的情况下抵达的最高层数",
        "Uncover the mysteries of the Zenith Tower.": "发掘天穹之塔的秘密。",
        "THE LOVERS": "恋人",
        "highest floor discovered with the \"DUO\" mod": "在双人成行规则牌下抵达的最高层数",
        "Love, and resign yourself to the fate of another.": "爱彼此，并去把握命中注定的缘分。",
        "TOWER CLIMBER": "攀塔者",
        "meters climbed": "攀登的米数",
        "\"Have I been here before..?\"": "“这给我爬哪来了...？”",
        "THE EMPEROR": "皇帝",
        "highest floor discovered with the \"Expert Mode\" mod": "在启用“专家难度”规则牌的情况下抵达的最高层数",
        ...
        "THE RESPONSIBLE ONE": "能力越大，责任越大",
        "highest amount of revivals performed in a single DUO run": "在一局双人模式中完成的最多复活次数",
        "\"Could you please stop dying?\"": "你能不能别老去送死？",
        "STRENGTH": "力量",
        "highest floor discovered with the \"VOLATILE GARBAGE\" mod": "在启用“垃圾堆”模组下抵达的最高层数",
        "Match great obstacles with greater determination.": "以强大的决心应对更大的挑战。",
        "SWAMP WATER": "沼泽水特调",
        "highest floor discovered while using all mods other than \"DUO\" at the same time": "在启用所有功能牌的情况下抵达的最高层数（不包括双人模式）",
        "The worst of all worlds.": "这充满恶意的世界。",
        "DEADLOCK": "僵局",
        "SWAMP WATER LITE":"沼泽水特调Lite",
        "Comes in 8 different flavors!":"有 8 种不同风味！",
        ...
        "highest total attack within the first 400 pieces placed while using the \"Expert Mode\" and \"Messier Garbage\" mods":"在启用“专家模式”和“乱糟糟”模组的情况下前400块发送的最多垃圾行",
        "Adversity favors the resourceful.":"逆境于智者有益。",
        "TALENTLESS":"无才",
        "highest floor discovered while using the \"All-Spin\" mod without performing any Spins":"在启用“全旋”规则牌且不使用任何特殊旋转的情况下抵达的最高层数",
        ...
        "EXPERT DUO":"双专家模式",
        "highest floor discovered while using the \"No Hold\", \"Double Hole Garbage\" and \"Messier Garbage\" mods": "在启用“禁止暂存”、“双洞诅咒”和“乱糟糟”规则牌的情况下抵达的最高层数",
        "\"Escape has become a distant dream, yet still we struggle...\"": "“纵使已深陷泥潭，我们仍永不言弃...”",
        "THE GRANDMASTER": "方块大师",
        "highest floor discovered while using the \"Gravity\" and \"Invisible\" mods": "在启用“重力”和“隐形”规则牌的情况下抵达的最高层数",
        "When the world descends into chaos, the grandmaster remains at peace.": "混乱尘世，大师巍然不动。",
        "THE ESCAPE ARTIST":"金蝉脱壳",
        "\"An impossible situation! A daring illusionist! Will he make it out alive?\"":"“只有死路一条的处境加上一个大胆的魔术师！他能创造奇迹吗？”",
        "garbage lines cleared using Spins while using the \"Double Hole Garbage\", \"Messier Garbage\" and \"All-Spin\" mods":"在启用“双洞诅咒”，“乱糟糟”和“全旋”规则牌的情况下消除的垃圾行数",
        "EMPEROR'S DECADENCE":"皇帝的懦弱",
        "highest floor discovered while using the \"Expert Mode\", \"Double Hole Garbage\" and \"No Hold\" mods":"在启用“专家难度”，“双洞诅咒”和“禁止暂存”模组的情况下抵达的最高层数",
        "The Devil's lesson in humility.":"吃一堑，长一智。",
        "DIVINE MASTERY":"天纵奇才",
        "highest floor discovered while using the \"Expert Mode\", \"Double Hole Garbage\", \"Volatile Garbage\" and \"Messier Garbage\" mods":"在启用“专家难度”，“双洞诅咒”，“垃圾堆”和“乱糟糟”规则牌的情况下抵达的最高层数",
        "The universe is yours.":"天下任你闯。",
        "TEMPERANCE":"克制",
        "highest floor discovered with the \"No Hold\" mod":"在启用“禁止暂存”模组的情况下抵达的最高层数",
        "Use each piece as they come and embrace the natural flow of stacking.":"随块而动，无为而堆，块法自然。",
        "WHEEL OF FORTUNE":"命运之轮",
        "highest floor discovered with the \"Messier Garbage\" mod":"在启用“乱糟糟”规则牌的情况下抵达的最高层数",
        "The only constant in life is change.":"生活，就是变中有变。",
        "A MODERN CLASSIC":"现代经典",
        "highest floor discovered while using the \"No Hold\" and \"Gravity\" mods":"在启用“禁止暂存”和“急剧重力”规则牌的情况下抵达的最高层数",
        "Times were different back then...":"时间要开始回溯了...",
        "THE DEVIL":"恶魔",
        "highest floor discovered with the \"Double Hole Garbage\" mod":"在启用“双洞诅咒”模组的情况下抵达的最高层数",
        ...
        "What will you do when it all comes crumbling down?":"当高塔崩摧之际，你会做些什么？",
        "THE HERMIT":"隐士",
        "highest floor discovered with the \"Invisible\" mod":"在启用“隐形”模组的情况下抵达的最高层数",
        "When the outside world fails you, trust the voice within to light a path.":"寡助者，天助之。",
        "THE MAGICIAN":"魔术师",
        "highest floor discovered with the \"All-Spin\" mod":"在启用“All-Spin”模组的情况下抵达的最高层数",
        "Inspiration is nothing short of magic.":"灵感是完美的魔法。",
        "TRAINED PROFESSIONALS":"专业团队",
        "highest floor discovered in a DUO while both players are using the \"Expert Mode\" mod":"在启用“双人模式”规则牌且双方均启用“专家难度”规则牌的情况下抵达的最高层数",
        ...
        "THE STARVING ARTIST": "绝处逢生",
        "highest floor discovered while using the \"No Hold\" and \"All-Spin\" mods": "在启用“禁止暂存”和“ALL-Spin”规则牌的情况下抵达的最高层数",
        ...
        "THE CON ARTIST": "瞒天过海",
        "highest floor discovered while using the \"Expert Mode\", \"Volatile Garbage\" and \"All-Spin\" mods": "在启用“专家难度”，“垃圾堆”和“ALL-Spin”规则牌的情况下抵达的最高层数",
        ...
        "highest BLITZ score obtained without using Hold": "在不使用暂存的情况下完成闪电战游戏模式下获得的最高分数",
        "THE TYRANT": "暴君",
        "highest floor discovered with the reversed \"Expert Mode\" mod": "在启用逆位“专家难度”规则牌的情况下抵达的最高层数",
        "Fear, oppression, and limitless ambition.": "恐惧、压迫，以及无限的野心。",
        "fear, oppression, and limitless ambition": "恐惧、压迫，以及无限的野心",
        "ASCETICISM": "禁欲",
        "highest floor discovered with the reversed \"No Hold\" mod": "在启用逆位“禁止暂存”规则牌的情况下抵达的最高层数",
        "A detachment from even that which is moderate.": "对哪怕是平凡之物的远离。",
        "a detachment from even that which is moderate": "对哪怕是平凡之物的远离",
        "LOADED DICE": "灌铅之骰",
        "highest floor discovered with the reversed \"Messier Garbage\" mod": "在启用逆位“乱糟糟”规则牌的情况下抵达的最高层数",
        "In a rigged game, your mind is the only fair advantage.": "在被操纵的游戏中，你的头脑是唯一合理的优势。",
        "in a rigged game, your mind is the only fair advantage": "在被操纵的游戏中，你的头脑是唯一合理的优势",
        "FREEFALL": "坠落",
        "highest floor discovered with the reversed \"Gravity\" mod": "在启用逆位“急剧重力”规则牌的情况下抵达的最高层数",
        "The ground you stood on never existed in the first place.": "立足之地已荡然无存。",
        "the ground you stood on never existed in the first place": "立足之地已荡然无存",
        "LAST STAND": "背水一战",
        "highest floor discovered with the reversed \"Volatile Garbage\" mod": "在启用逆位“垃圾堆”规则牌的情况下抵达的最高层数",
        "Strength isn't necessary for those with nothing to lose.": "对那些一无所有的人来说，力量并不重要。",
        "strength isn't necessary for those with nothing to lose": "对那些一无所有的人来说，力量并不重要",
        "DAMNATION": "天谴",
        "highest floor discovered with the reversed \"Double Hole Garbage\" mod": "在启用逆位“双洞诅咒”规则牌的情况下抵达的最高层数",
        "Neither the freedom of life or peace of death.": "生无自由，死无安宁。",
        "neither the freedom of life or peace of death": "生无自由，死无安宁",
        "THE EXILE": "放逐",
        "highest floor discovered with the reversed \"Invisible\" mod": "在启用逆位“隐形”规则牌的情况下抵达的最高层数",
        "Never underestimate blind faith.": "永远不要低估盲目的信仰。",
        "never underestimate blind faith": "永远不要低估盲目的信仰",
        "THE WARLOCK": "邪术师",
        "highest floor discovered with the reversed \"All-Spin\" mod": "在启用逆位“全旋”模规则牌的情况下抵达的最高层数",
        "Into realms beyond heaven and earth.": "踏入超脱天地之境界。",
        "into realms beyond heaven and earth": "踏入超脱天地之境界",
        "THE HARBINGER": "先驱",
        "Reach floor 3 in all eight reversed mods": "在启用各个逆位模组的情况下抵达第三层",
        "Weathering the storm of an unfavorable future.": "承受着击碎未来的飓风。",
        "COMPETITIVE": "竞争性",
        ...
        "Offline": "离线",
        "invited you to": "邀请你",
        "Please be civil. Staff will never ask for your credentials.": "请文明交流。官方客服永远不会索要您的个人信息。",
        "ONLINE": "在线",
        "Away": "离开",
        "Playing": "正在玩",
        "Busying": "正忙",
        ...
        "RELOAD": "重新加载",
        "TETR.IO requires WEBGL": "TETR.IO需要WEBGL权限",
        ...
        "Even as we bleed, we keep holding on...": "即使我们遍体鳞伤，我们仍守望相助...",
        ...
        "A journey of one thousand six hundred fifty meters starts with a single step.": "一千余六百五十里的旅程始于一小步。",
        "A FOOL'S ERRAND": "愚昧的徒劳",
        "Escape floor 1 while using the reversed \"PENTR.IO\" mod": "在启用“PENTR.IO”模组下抵达第二层",
        "You'll never escape who you are.": "江山易爬，本性难移。",
        "you'll never escape who you are": "江山易爬，本性难移",
        "": "",
        "": "",
        "": "",
        ...
        "Zenith Tower - TETR.IO Original Soundtrack": "天穹之塔 - TETR.IO 原声音乐",
        ...
        "As a 2023 holidays special, our programmer, sound designer and composer Dr Ocelot has created two very special tracks, a main menu remix and a new Blitz song! Remastered in 2024.": "作为 2023 年的节日特辑，我们的程序员、音效设计师和作曲家 Dr.Ocelot 创作了两首非常特别的曲目，其中一首是主菜单混音版音乐，另一首是新的闪击战游戏模式的背景音乐！在2024 年重新制作。",
        "Holidays 2024 - TETR.IO Original Soundtrack": "2024 节日 - TETR.IO 原声音乐",
        "TETR.IO once again gets a festive makeover, which wouldn't be complete without a new soundtrack! Including new renditions of the 2023 tracks, as well as new tracks for the limited-time Snowball Board event!": "TETR.IO 在节日期间再次改头换面，如果没有新的配乐，那就太不西告了！包括 2023 曲目的全新演绎，以及限时活动雪球版面的新曲目！",
        "Free download": "免费下载",
        "": "",
        "": "",
        "": "",
